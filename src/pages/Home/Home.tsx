        ...
        <div className={styles.featureSectionWrapper}>
          ...
          <div className={styles.featureItemContainer}>
            <FeatureItem
              ...
              imageSrcWebM={trendingWebM}
            />
            <FeatureItem title="Find gif for free" imageSrc={findGif} imageSrcWebM={findWebM} />
            <FeatureItem title="Free for everyone" imageSrc={freeGif} imageSrcWebM={freeWebM} />
          </div>
          <Link to="/search">
