        ...
        <div className={styles.featureSectionWrapper}>
          ...
          <div className={styles.featureItemContainer}>
            <FeatureItem
              ...
              defaultImageSrc={trendingGif}
            />
            <FeatureItem title="Find gif for free" imageSrc={findWebm} defaultImageSrc={findGif} />
            <FeatureItem title="Free for everyone" imageSrc={freeWebm} defaultImageSrc={freeGif} />
          </div>
          <Link to="/search">
