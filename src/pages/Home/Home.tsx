      ...
      <section ref={wrapperRef} className={styles.featureSection}>
        ...
        <div className={styles.featureSectionWrapper}>
          ...
          <div className={styles.featureItemContainer}>
            <FeatureItem title="See trending gif" videoSrcList={[trendingWebm, trendingMp4]} />
            <FeatureItem title="Find gif for free" videoSrcList={[findWebm, findMp4]} />
            <FeatureItem title="Free for everyone" videoSrcList={[freeWebm, freeMp4]} />
          </div>
          <Link to="/search">
