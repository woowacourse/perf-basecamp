  ...
  return (
    <>
      <section className={styles.heroSection}>
        <picture>
          <source className={styles.heroImage} srcSet={heroWebp} type="image/webp" />
        ...
        <div className={styles.featureSectionWrapper}>
          ...
          <div className={styles.featureItemContainer}>
            <FeatureItem
              ...
              imageSrc={{ gif: trendingGif, webp: trendingWebp }}
            />
            <FeatureItem title="Find gif for free" imageSrc={{ gif: findGif, webp: findWebp }} />
            <FeatureItem title="Free for everyone" imageSrc={{ gif: freeGif, webp: freeWebp }} />
          </div>
          <Link to="/search">
