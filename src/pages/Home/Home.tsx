      ...
      <section ref={wrapperRef} className={styles.featureSection}>
        ...
        <div className={styles.featureSectionWrapper}>
          ...
          <div className={styles.featureItemContainer}>
            <FeatureItem title="See trending gif" webmSrc={trendingWebm} />
            <FeatureItem title="Find gif for free" webmSrc={findWebm} />
            <FeatureItem title="Free for everyone" webmSrc={freeWebm} />
          </div>
          <Link to="/search">
