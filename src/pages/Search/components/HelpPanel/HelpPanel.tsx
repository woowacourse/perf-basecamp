    ...
    <>
      ...
      >
        <div className={styles.sheetTitleContainer}>
          ...
          <button title="help panel close button" type="button" onClick={closeSheet}>
        ...
        <div className={styles.sheetContentsContainer}>
          <img
            ...
            alt="Animated GIF demonstrating GIPHY's content"
          />
          <p>
          ...
          <img
            ...
            alt="GIPHY artist directory illustration"
          />
          <p>
