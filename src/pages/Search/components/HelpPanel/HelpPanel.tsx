      ...
      >
        ...
        <div className={styles.sheetContentsContainer}>
          <img
            ...
            alt="A GIF demonstrating the Memegle service"
          />
          <p>
          ...
          <img
            ...
            alt="A GIF showcasing the artist directory"
          />
          <p>
            If you want more, you are always welcome to contribute as an artist. Please refer to
            &nbsp;
            <a
              href="https://support.giphy.com/hc/en-us/articles/360019977552-How-to-Upload"
              target="_blank"
