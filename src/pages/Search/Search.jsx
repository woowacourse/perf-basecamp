...
import { useTrendingGifs } from '../../contexts/TrendingGifsProvider';
...
const Search = () => {
  ...
  const { trendingGifs, hasTrendingGifsViewed, saveTrendingGifs } =
    useTrendingGifs();
